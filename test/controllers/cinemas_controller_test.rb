...
class CinemasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cinema" do
    assert_difference("Cinema.count") do
      post cinemas_url, params: { cinema: { cinema_id: @cinema.cinema_id, county: @cinema.county, title: @cinema.title, uri: @cinema.uri } }
    end
  ...
  test "should update cinema" do
    patch cinema_url(@cinema), params: { cinema: { cinema_id: @cinema.cinema_id, county: @cinema.county, title: @cinema.title, uri: @cinema.uri } }
